...
if reload_FIT_tables or reload_comp_libs:
    ...
    my_read_arch_comp_lib_syn(q, "hch4nvcfc")
    ...
    my_read_arch_comp_lib_syn(q, "parmcdpddr")
    my_read_arch_comp_lib_syn(q, "parmc2lmddr")
    my_read_arch_comp_lib_syn(q, "paribluc")
    my_read_arch_comp_lib_syn(q, "pariblsb")
    my_read_arch_comp_lib_syn(q, "pariblmem")
    my_read_arch_comp_lib_syn(q, "pariblcse")
    my_read_arch_comp_lib_syn(q, "parhcachassis")
    my_read_arch_comp_lib_syn(q, "parhcapsf")
    my_read_arch_comp_lib_syn(q, "uboxpar")
    my_read_arch_comp_lib_syn(q, "scf_ubox_miscpar")
    my_read_arch_comp_lib_syn(q, "par_hqm_credit_hist_pipe")
    my_read_arch_comp_lib_syn(q, "par_hqm_dir_pipe")
    my_read_arch_comp_lib_syn(q, "par_hqm_dqed_pipe")
    my_read_arch_comp_lib_syn(q, "par_hqm_iosf")
    my_read_arch_comp_lib_syn(q, "par_hqm_list_sel_pipe")
    my_read_arch_comp_lib_syn(q, "par_hqm_nalb_pipe")
    my_read_arch_comp_lib_syn(q, "par_hqm_qed_pipe")
    my_read_arch_comp_lib_syn(q, "par_hqm_system")
    my_read_arch_comp_lib_syn(q, "pardinomisc")
    my_read_arch_comp_lib_syn(q, "pardsa")
    my_read_arch_comp_lib_syn(q, "pariax1")
    my_read_arch_comp_lib_syn(q, "pariax2")
    my_read_arch_comp_lib_syn(q, "pariax3")
    my_read_arch_comp_lib_syn(q, "parnrthpk")
    my_read_arch_comp_lib(q, "parpsf")
    my_read_arch_comp_lib(q, "parcpmaram")
    my_read_arch_comp_lib(q, "parcpmcast1")
    my_read_arch_comp_lib_syn(q, "parcpmhi")
    my_read_arch_comp_lib_syn(q, "parcpmssma_xa")
    my_read_arch_comp_lib(q, "parcpmssmb")
    my_read_arch_comp_lib_syn(q, "parcpmssmc_xa")
    my_read_arch_comp_lib_syn(q, "parcpmssmd_xa")
    my_read_arch_comp_lib_syn(q, "parcpmssme_xa")
    my_read_arch_comp_lib_syn(q, "parcpmssmf")
    my_read_arch_comp_lib_syn(q, "parcpmssmg_xa")
    my_read_arch_comp_lib_syn(q, "vchinf_mc")
